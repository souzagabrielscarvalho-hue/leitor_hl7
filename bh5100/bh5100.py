...
# edite o arquivo config_bh5100.json que fica ao lado do executável.
# Se o arquivo não existir, ele será criado automaticamente na primeira execução.
_config, _config_status = load_config('bh5100', {
    'com_port': 'COM3',
    'baud_rate': 9600,
    'franchise_credential_id': 'f47d9a16-df12-4091-b759-79648d13e371',
    'webhook_url': 'https://apoio.internal.vidaexame.com/api/integration/bh5100?franchise_credential_id={franchise_credential_id}',
})
